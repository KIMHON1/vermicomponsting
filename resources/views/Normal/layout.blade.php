...
<html lang="en">
    ...
    <body>
        ...
        >
            <p class="ml-2">Copyright &copy; 2023, Alll Rights reserved</p>
...
<head>
  ...
  <title>Vermicomposting System</title>
...
<body>
  ...
  <header id="header" class="header d-flex align-items-center">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between ">
      <a href="" class="logo d-flex align-items-center">
        ...
        <h1>Vermicomposting<span>.</span></h1>
      </a>
      <nav id="navbar" class="navbar py-3 py-lg-5">
        <ul>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-info">
          ...
          <p>The animal dungs such as cattle dung, goat dung, sheep dung and poultry dropping are used as the composting material. The preliminary testing and precautions are necessary for the pathogens which can be harmful to earthworms excepting cowdung..</p>
        ...
        <div class="col-lg-2 col-6 footer-links">
          <h4>Our Services</h4>
          <ul>
            <li><a href="#">Automate vermicomposting </a></li>
        ...
        <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
          ...
          <p>
            ...
            <strong>Email:</strong>vermicomposting@gmail.com<br>
          </p>
    ...
    <div class="container mt-4">
      <div class="copyright">
        &copy; Copyright <strong><span>Vermicomposting</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
